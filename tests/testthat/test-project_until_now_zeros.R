...
test_that(
  "project_until_now_zeros fills future values with zero when proxies stay at zero",
  {
    x <- make_co2(
...
test_that(
  "project_until_now_zeros does not fill when future proxy values are non-zero",
  {
    x <- make_co2(
      dates = c("2020-01-01", "2020-02-01"),
      values = c(5, 0)
...
test_that(
  "project_until_now_zeros does not fill when latest value is non-zero",
  {
    x <- make_co2(
      dates = c("2020-01-01", "2020-02-01"),
      values = c(5, 2)
