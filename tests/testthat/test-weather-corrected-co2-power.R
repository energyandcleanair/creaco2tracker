test_that(
  "Simple case: 10% more renewables reduces emissions by 6%",
  {
...
test_that(
  "Bad weather case: less renewables increases emissions by 6%",
  {
...
test_that(
  "Zero thermal share returns correction_factor = 1",
  {
...
test_that(
  "Mixed wind and solar sources combine correctly",
  {
...
test_that(
  "YTD aggregation filters correctly",
  {
...
test_that(
  "NA and infinite values handled correctly",
  {
