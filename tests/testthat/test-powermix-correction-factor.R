test_that(
  "calculate_powermix_correction_factor handles basic case correctly",
  {
...
test_that(
  "calculate_powermix_correction_factor caps at historical max thermal",
  {
...
test_that(
  "calculate_powermix_correction_factor prevents negative thermal",
  {
...
test_that(
  "calculate_powermix_correction_factor handles edge cases",
  {
    # Case 6: Single value
    thermal <- 500000
    ...
    # thermal is scalar and recycled against renewable_delta
    expected <- c(
      (500000 - 10) / 500000,
      (500000 - 10) / 500000,
      (500000 - 10) / 500000
...
test_that(
  "calculate_powermix_correction_factor matches inline formula",
  {
...
test_that(
  "calculate_powermix_correction_factor real-world scenario",
  {
...
test_that(
  "EU emission-weighted average is correct",
  {
