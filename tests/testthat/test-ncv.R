...
test_that(
  "create_siec_fuel_mapping returns correct structure",
  {
...
test_that(
  "validate_ncv_completeness catches missing NCV values",
  {
...
test_that(
  "validate_ncv_completeness handles ME country code correctly",
  {
...
test_that(
  "make_ncv_time_insensitive works correctly",
  {
    test_data_with_ncv <- test_data() %>%
      mutate(
        iso2 = "DE",
...
test_that(
  "add_ncv_to_data handles missing conversion factors gracefully",
  {
...
test_that(
  "calculate_weighted_means works correctly",
  {
...
test_that(
  "fill_missing_conversion_factors handles edge cases",
  {
...
test_that(
  "add_ncv_iea function structure is correct",
  {
