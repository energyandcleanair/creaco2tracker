...
test_that(
  "combine_monthly_yearly_with_cutoff works correctly with valid data",
  {
    # Create test data
...
test_that(
  "combine_monthly_yearly_with_cutoff handles different fuel types correctly",
  {
...
test_that(
  "combine_monthly_yearly_with_cutoff handles country-specific cutoffs",
  {
...
test_that(
  "combine_monthly_yearly_with_cutoff handles missing data gracefully",
  {
...
test_that(
  "combine_monthly_yearly_with_cutoff prioritizes monthly over yearly when both available",
  {
...
test_that(
  "combine_monthly_yearly_with_cutoff handles edge cases with no monthly data",
  {
