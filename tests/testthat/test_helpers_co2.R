...
test_that(
  "split_gas_to_elec_others infers 'others' from 'all' and 'electricity'",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_others infers 'electricity' from 'all' and 'others'",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_others returns unchanged if already split",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_others returns unchanged if all sectors present",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_others infers both as NA if only 'all' present",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_others infers 'others' as NA if only 'electricity' present",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_others infers 'electricity' as NA if only 'others' present",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_others leaves non-gas data unchanged",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_others fails on duplicate data",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_others handles NA values",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_all infers 'all' from 'electricity' and 'others'",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_all returns unchanged if already combined",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_all handles only 'all' present",
  {
    test_data <- tibble(
...
test_that(
  "split_gas_to_elec_all leaves non-gas data unchanged",
  {
    test_data <- tibble(
...
test_that(
  "detotalise_co2 fills missing others placeholders from all and known sectors",
  {
    test_data <- tibble(
      iso2 = "EU",
      geo = "EU",
    ...
    expect_false("all" %in% res$sector)
    expect_equal(
      res %>% filter(sector == "others") %>% pull(value),
      55
    )
  }
)
...
test_that(
  "detotalise_co2 overwrites inconsistent others when all and sectors coexist",
  {
    test_data <- tibble(
      iso2 = "EU",
      geo = "EU",
    ...
    expect_equal(
      result %>% filter(sector == "others") %>% pull(value),
      22
    )
