...
test_that(
  "get_weather works with solar_radiation for single country",
  {
    result <- get_weather(
...
test_that(
  "get_weather works with wind speed from stations",
  {
    skip_if_not(
      Sys.getenv("TEST_LOCAL_API") == "TRUE",
...
test_that(
  "get_weather works with multiple region_ids",
  {
...
test_that(
  "get_weather works with all EU countries",
  {
...
test_that(
  "get_weather caching works correctly",
  {
    params <- list(
      variable = "CDD",
      region_iso2 = "ES",
...
test_that(
  "get_weather handles multiple variables",
  {
    result <- get_weather(
      variable = "HDD,CDD",
      region_iso2 = "FR",
...
test_that(
  "get_weather returns lowercase variable names",
  {
    result <- get_weather(
      variable = "HDD,CDD",
      region_id = "EU",
...
test_that(
  "get_weather handles date range correctly",
  {
    result <- get_weather(
      variable = "HDD",
      region_iso2 = "IT",
...
test_that(
  "get_weather required columns are present",
  {
    result <- get_weather(
      variable = "solar_radiation",
      region_iso2 = "PT",
